...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QLed_t, stringdata) + ofs \
...
const QMetaObject QLed::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QLed.data,
...
void *QLed::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QLed.stringdata))
